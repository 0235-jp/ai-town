...
export const ACTIVITIES = [
  { description: '本を読んでいる', emoji: '📖', duration: 60_000 },
  { description: '考え事をしている', emoji: '🤔', duration: 60_000 },
  { description: '庭いじりをしている', emoji: '🥕', duration: 60_000 },
];
